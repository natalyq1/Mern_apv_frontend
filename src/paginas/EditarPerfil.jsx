      ...
      <section className="flex justify-center my-2">
        ...
        {msg && <Alerta alerta={alerta} />}
          ...
          onSubmit={handleSubmit}>
            ...
            <div className="my-4">
              <label className="uppercase font-bold text-gray-600" htmlFor="">Sitio web
              </label>
              <input type="text" 
              className="border bg-gray-50 w-full p-2 mt-5 rounded-lg" 
              name="web"
...
<div className="my-4">
              <label className="uppercase font-bold text-gray-600" htmlFor="">Telefono
              </label>
              <input type="text"
              className="border bg-gray-50 w-full p-2 mt-5 rounded-lg"
              name="telefono"
...
<div className="my-4">
              <label className="uppercase font-bold text-gray-600" htmlFor="">Correo
              </label>
              <input type="text" 
              className="border bg-gray-50 w-full p-2 mt-5 rounded-lg"
              name="email"
